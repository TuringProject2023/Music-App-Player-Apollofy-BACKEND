...
export const createPlaylist = async (
  ...
  try {
    ...
    return res
      .status(201)
      .send({ message: "playlist created successfully", newPlaylist });
  } catch (err) {
...
export const getPlaylistById = async (
  ...
  try {
    ...
    return res
      .status(200)
      .send({ message: "playlist getted successfully", gettedPlaylist });
  } catch (err) {
    console.error(err); // Log the error to the console for debugging purposes
    // In case of internal error, return an error message with status code 500
    return res.status(500).send({ error: "Internal server error" });
...
export const getAllPlaylist = async (
  ...
  try {
    ...
    return res
      .status(200)
      .send({
        message: "All playlists getted successfully",
        gettedAllPlaylist,
      });
  } catch (err) {
    console.error(err); // Log the error to the console for debugging purposes
...
export const updatePlaylist = async (
  ...
  try {
    ...
    return res
      .status(200)
      .send({ message: "Playlist updated successfully", updatePlaylist });
  } catch (err) {
    console.error(err); // Log the error to the console for debugging purposes
    // In case of internal error, return an error message with status code 500
    return res.status(500).send({ error: "Internal server error" });
...
export const deletePlaylistById = async (
  ...
  try {
    ...
    return res
      .status(200)
      .send({ message: "Playlist deleted successfully", deletedPlaylist });
  } catch (err) {
    console.error(err); // Log the error to the console for debugging purposes
    // In case of internal error, return an error message with status code 500
    return res.status(500).send({ error: "Internal server error" });
