...
export const AlbumCreateForm: FC<userFormModal> = ({ closeModal }) => {
  ...
  return (
    <AlbumFormContainer>
      ...
      {isSuccess && <AlertMessageSuccess>Album create successfully</AlertMessageSuccess>}
      <header>Create Album</header>
      <form className="form" onSubmit={handleSubmit(onSubmit)}>
        <div className="input_box">
          <label className="" htmlFor="albumName">
            Name
          </label>
          <input
            {...register("albumName", {
          ...
          <label className="albumCreatedAtLabel" htmlFor="albumCreatedAt">
            Creation date
          </label>
          <input
...
const AlbumFormContainer = styled.section`
  max-width: 500px;
  width: 100%;
