...
export * from './dropdownMenu/AddDropdownMenu';
export * from './dropdownMenu/ProfileDropdownMenu';
...
export * from './mainHome/home-albumsContainer/AlbumMainContainer';
...
export * from './modal/modalUpdateAlbum/DeleteAlbumModal';
export * from './modal/modalUpdateAlbum/DropDownMenuAlbum';
export * from './modal/modalUpdateAlbum/ModalUpdateAlbum';
